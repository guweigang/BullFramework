...
class Bull_Php
{
    ...
    public function __construct($bull_config)
    {
        $this->_bull_config = $bull_config;
    }
    ...
    protected function _buildBullCode($code)
    {
        ...
        $code = 'define("BULL_CONFIG_MODE", "'.$this->_bull_config['mode'].'");'
            . 'define("ROOT", "'.$this->_bull_config['root'].'");'
